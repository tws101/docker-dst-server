...
---------------------------WORLD SETTINGS---------------------------
	...
	-- ISLAND ANIMALS
	wildbores="default",					-- Prime Apes: 					"never", "rare", "default", "often", "always"
	primeape="default",						-- Wildbores: 					"never", "rare", "default", "often", "always"
...
---------------------------WORLD GENERATION---------------------------    
	...
	-- SHIPWRECKED WORLD
	primaryworldtype="volcanoonly",			-- World Type: 					"islandsonly", "volcanoonly", "default",
	...
	poi="never",					--? Unknown 
	wormhole_prefab="tentacle_pillar",			--"wormhole", "tentacle_pillar"
	},
