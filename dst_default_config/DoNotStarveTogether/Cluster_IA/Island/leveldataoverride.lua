...
---------------------------WORLD SETTINGS---------------------------
	...
	-- SHIPWRECKED GLOBAL
	clocktype="tropical",					-- Clock Type: 					"default", "tropical"
	mild="default", 						-- Mild: 						"noseason", "veryshortseason", "shortseason", "default", "longseason", "verylongseason", "random"
	hurricane="default", 					-- Hurricane: 					"noseason", "veryshortseason", "shortseason", "default", "longseason", "verylongseason", "random"
	monsoon="default",						-- Monsoon: 					"noseason", "veryshortseason", "shortseason", "default", "longseason", "verylongseason", "random"
	dry="default", 							-- Dry: 						"noseason", "veryshortseason", "shortseason", "default", "longseason", "verylongseason", "random"
	...
	frograin="never",						-- Frog Rain:					(DO NOT CHANGE OR YOU DIE)
	alternatehunt="default",				-- Hunt Surprises: 				"never", "rare", "default", "often", "always"
	hunt="never",							-- Hunts: 						(DO NOT CHANGE OR YOU DIE)
	...
	wildfires="never",						-- Wildfires: 					(DO NOT CHANGE OR YOU DIE)

	
	-- SHIPWRECKED WORLD 
	no_dst_boats="auto",					-- DST Boats (WIP):				"auto", "none", "always"
	has_ia_boats="auto",					-- IA Boats (WIP):				"auto", "none", "always"
	has_ia_drowning="auto",					-- Deadly Drowning: 			"auto", "none", "always"
	dragoonegg="default",					-- Dragoon Eggs: 				"never", "rare", "default", "often", "always"
	floods="default",						-- Floods: 						"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"	
	poison="default",						-- Poison: 						"never", "default" 
	oceanwaves="default",					-- Waves: 						"never", "rare", "default", "often", "always"
	whalehunt="default",					-- Whaling: 					"never", "rare", "default", "often", "always"
	...
	-- SHIPWRECKED RESOURCE REGROWTH
	jungletree_regrowth="default",			-- Jungle Trees: 				"never", "veryslow", "slow", "default", "fast", "veryfast"
	palmtree_regrowth="default",			-- Palm Trees: 					"never", "veryslow", "slow", "default", "fast", "veryfast"
	sweet_potato_regrowth="default",		-- Sweet Potatoes: 				"never", "veryslow", "slow", "default", "fast", "veryfast"
	...
	perd="never",							-- Gobblers:					"never", "rare", "default", "often", "always"
	...
	penguins="never",						-- Pengulls: 					"never", "rare", "default", "often", "always"
	...
	-- SHIPWRECKED ANIMALS (SPAWN RATES)
	ballphin_setting="default",				-- Ballphins: 					"never", "rare", "default", "often", "always"
	crab_setting="default",					-- Crabbits: 					"never", "rare", "default", "often", "always"
	solofish_setting="default",				-- Dogfish: 					"never", "rare", "default", "often", "always"
	fishermerm_setting="default",			-- Fisher Merms: 				"never", "rare", "default", "often", "always"
	jellyfish_setting="default",			-- Jellyfish: 					"never", "rare", "default", "often", "always"
	primeape_setting="default",				-- Prime Apes: 					"never", "rare", "default", "often", "always"
	sharkitten_setting="default",			-- Sharkittens: 				"never", "rare", "default", "often", "always"
	wildbores_setting="default",			-- Wildbores: 					"never", "rare", "default", "often", "always"
	lobster_setting="default",				-- Wobsters: 					"never", "rare", "default", "often", "always"
	...
	-- SHIPWRECKED HOSTILE CREATURES (SPAWN RATES)
	dragoon_setting="default",				-- Dragoons: 					"never", "rare", "default", "often", "always"
	mosquito="default",						-- Poison Mosquitos: 			"never", "rare", "default", "often", "always"
	stungray_setting="default",				-- Stink Rays: 					"never", "rare", "default", "often", "always"
	swordfish_setting="default",			-- Swordfish:					"never", "rare", "default", "often", "always"

	-- GIANTS (SPAWN RATES)
	antliontribute="default",				-- Antlion Tribute: 			"never", "rare", "default", "often", "always"
	bearger="never",						-- Bearger: 					"never", "rare", "default", "often", "always"
	beequeen="default",						-- Bee Queen: 					"never", "rare", "default", "often", "always"
	crabking="default",						-- Crabking: 					"never", "rare", "default", "often", "always"
	deerclops="never",					-- Deerclops:					"never", "rare", "default", "often", "always"
	...
	-- SHIPWRECKED GIANTS (SPAWN RATES)
	kraken="default",						-- Quacken: 					"never", "rare", "default", "often", "always"	
	twister="default",						-- Sealnado: 					"never", "rare", "default", "often", "always"
	tigershark="default",					-- Tiger Sharks: 				"never", "rare", "default", "often", "always"
...
---------------------------WORLD GENERATION---------------------------    
	...
	roads="never",							-- Roads: 						(DO NOT CHANGE OR YOU DIE)
	...
	prefabswaps_start="classic",			-- Starting Resource Variety: 	(DO NOT CHANGE OR YOU DIE)
	moon_fissure="default",					-- Celestial Fissures: 			"never", "rare", "uncommon", "default", "often", "mostly", "always"
	stageplays="never",					-- Stage Plays:					"never","default"
	terrariumchest="default",				-- Terrarium:					"never", "default"
	
	-- SHIPWRECKED WORLD
	bermudatriangle="default",				-- Electric Isosceles: 			"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	volcano="default",						-- Volcano: 					"never", "default"
	volcanoisland="none",					-- Volcano Island: 				"always","none"
	primaryworldtype="islandsonly",			-- World Type: 					"islandsonly", "volcanoonly", "default"
	...
	-- SHIPWRECKED RESOURCES (QUANTITY GENERATED)
	bamboo="default",						-- Bamboo: 						"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	bioluminescence="default",				-- Bioluminescence: 			"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	coral_brain_rock="default",				-- Brainy Sprouts: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	coral="default",						-- Corals: 						"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	crate="default",						-- Crates: 						"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	limpets="default",						-- Limpets: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	magma_rocks="default",					-- Magma Rocks: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	mussel_farm="default",					-- Mussels: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	poisonhole="default",					-- Poisonous Holes: 			"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	sandhill="default",						-- Sandy Piles: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	seashell="default",						-- Seashells: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	seaweed="default",						-- Seaweeds: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	sweet_potato="default",					-- Sweet Potatoes: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	tar_pool="default",						-- Tar Pools: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	tidalpool="default",					-- Tidal Pools: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	bush_vine="default",					-- Viney Bushes: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	...
	-- SHIPWRECKED CREATURES AND SPAWNERS (QUANTITY GENERATED)
	ballphin="default",						-- Ballphin Palaces: 			"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	crabhole="default",						-- Crabbit Holes: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	solofish="default",						-- Dogfish: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	doydoy="default",						-- Doydoys: 					"never", "default"
	fishermerm="default",					-- Fisher Merm Huts: 			"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	jellyfish="default",					-- Jellyfish: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	primeape="default",						-- Prime Ape Huts: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	seagull="default",						-- Seagulls: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	fishinhole="default",					-- Shoals: 						"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	ox="default",							-- Water Beefalos: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	wildbores="default",					-- Wildbore Houses: 			"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	lobster="default",						-- Wobster Dens: 				"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	...
	-- SHIPWRECKED HOSTILE CREATURES AND SPAWNERS (QUANTITY GENERATED)
	flup="default",							-- Flup: 						"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	stungray="default",						-- Stink Rays: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
	swordfish="default",					-- Swordfish: 					"never", "rare", "uncommon", "default", "often", "mostly", "always", "insane"
